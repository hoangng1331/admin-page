...
import ShipperMenu from './components/ShipperMenu';
import ManagerMenu from './components/ManagerMenu';
import CSupportMenu from './components/CSupportMenu';
           ...
           <Layout>
             <Header style={{ backgroundColor: 'blue' }}>
               <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                 <h1 style={{ color: 'white' }}> D.CHIC Online - {auth?.loggedInUser?.role}</h1>
